  ...
  filterData(value: any) {
    ...
    if (this.textSearch) {
      this.customers.forEach((customer: any) => {
        if ( (!this.textSearch  || customer.customerId?.toUpperCase().includes(this.textSearch.toUpperCase()) || customer.name?.toUpperCase().includes(this.textSearch.toUpperCase()))) {
